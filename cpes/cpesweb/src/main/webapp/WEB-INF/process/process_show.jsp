...
<body>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
                  <img id="procDefImg" src="${pageContext.request.contextPath}/upload/loading-1.gif">
			  </div>
			</div>
        </div>
      </div>
	...
	$(function () {
		...
		$("#procDefImg").attr("src", "${pageContext.request.contextPath}/process/loadImg.do?id=${procDefid}&_=" + new Date().getTime());
    });
	</script>
</body>
</html>