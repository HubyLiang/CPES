 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form id="applyForm" method="post" action="${pageContext.request.contextPath}/member/startProcess.do" role="form" style="margin-top:20px;">
		  <div class="form-group">
			<label for="exampleInputEmail1">邮箱地址</label>
			<input type="text" class="form-control" id="femail" name="email" value="${loginMember.email}" placeholder="请输入真实名称">
		  </div>
