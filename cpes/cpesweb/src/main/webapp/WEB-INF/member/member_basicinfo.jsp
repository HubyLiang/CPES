 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form id="applyForm" method="post" action="${pageContext.request.contextPath}/member/updateMemberBasicInfo.do" role="form" style="margin-top:20px;">
		  ...
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="cardno" name="cardno" placeholder="请输入身份证号码">
		  </div>
		  <div class="form-group">
