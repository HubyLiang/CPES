 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form id="applyForm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/member/uploadCertFile.do" role="form" style="margin-top:20px;">
			<c:forEach items="${certs }" var="cert">
			  <div class="form-group">
				<label for="exampleInputEmail1">${cert.name}</label>
				<input type="file" class="form-control" name="certfile-${cert.id}" >
