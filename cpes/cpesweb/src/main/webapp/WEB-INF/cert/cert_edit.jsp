...
<body>
			  ...
			  <div class="panel-body">
				<form action="${pageContext.request.contextPath}/cert/insertCert.do" method="post" id="certForm" cert="form">
				  <div class="form-group">
				  	<input type="hidden" id="id" name="id" value="${cert.id }">
					<label for="exampleInputEmail1">资质名称</label>
					<input type="text" class="form-control" id="name" name="name" value="${cert.name }">
				  </div>
	...
	<script type="text/javascript">
		...
		$("#saveBtn").click(function () {
			...
			var paramObj = {
					url		:	"${pageContext.request.contextPath}/cert/updateCert.do",
					type	:	"POST",
					data	:	dataObj,
